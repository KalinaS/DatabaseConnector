...
public interface SqlQuery {
	...
	static final String SELECT_BY_NAME_ORDER_BY_DATE = "Select  * from file f where f.name = ? order by f.addingDate desc limit 1";
	static final String SELECT_BY_NAME = "Select * from file f where name = ?";
	static final String SELECT_BY_NAME_LIMIT = "Select * from file where name = ? order by file_id desc limit ?";
